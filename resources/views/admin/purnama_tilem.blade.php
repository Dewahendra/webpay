<x-admin-layout>
    ...
    <h1 class="text-3xl text-black pb-6">Purnama-Tilem</h1>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <div class="col-span-6 p-4 flex justify-end">
                  <form action="{{route('purnama_tilem.index')}}" method="GET">
                ...
                <div class="shadow px-6 py-4 bg-gray-50 rounded sm:px-1 sm:py-1">
                  <div class="grid grid-cols-12">
                      <div class="col-span-6 p-4">
                          <a href="{{route('purnama_tilem.create')}}"><button class="px-4 py-1 text-sm rounded text-purple-600 font-semibold border border-purple-400 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none">Tambah Data</button></a>
                <?php $No=1;?>
                ...
                <tr>
                  ...
                  <form action="{{route('purnama_tilem.destroy', $item->id)}}" method="POST">
                    @csrf
                    @method('DELETE')
                  <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                    <a href="{{route('purnama_tilem.edit', $item->id)}}" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-indigo-500 text-white hover:text-white">Edit</a>
